...
const (
	WebhookService_ListWebhooks_FullMethodName          = "/kapp.v1.WebhookService/ListWebhooks"
	WebhookService_GetWebhook_FullMethodName            = "/kapp.v1.WebhookService/GetWebhook"
	WebhookService_CreateWebhook_FullMethodName         = "/kapp.v1.WebhookService/CreateWebhook"
	WebhookService_UpdateWebhook_FullMethodName         = "/kapp.v1.WebhookService/UpdateWebhook"
	WebhookService_DeleteWebhook_FullMethodName         = "/kapp.v1.WebhookService/DeleteWebhook"
	WebhookService_ListWebhookDeliveries_FullMethodName = "/kapp.v1.WebhookService/ListWebhookDeliveries"
)
...
var WebhookService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kapp.v1.WebhookService",
	...
	Metadata: "kapp/v1/webhook.proto",
}
